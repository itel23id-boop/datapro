...
class getIstanaMarket extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:istanamarket';
    ...
    public function handle()
    {
        ...
        if($api->istanamarket_status == "Active") {
            ...
            $output = [0 => ['result' => false,'data' => 'Failed to retrieve ISTANA MARKET data with inactive status']];
        }
