...
class getRasxmedia extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:rasxmedia';
        ...
        if($api->rasxmedia_status == "Active") {
            foreach(Kategori::get() as $kategori){
                foreach($res['data'] as $data){
                    if($kategori->provider == "rasxmedia") {
            ...
            $output = [0 => ['result' => false,'data' => 'Failed to retrieve RASXMEDIA data with inactive status']];
        }
