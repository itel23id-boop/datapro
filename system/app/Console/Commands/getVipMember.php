...
class getVipMember extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'get:vipmember';
    ...
    public function handle()
    {
        ...
        if($api->vipmember_status == "Active") {
            ...
            $output = [0 => ['result' => false,'data' => 'Failed to retrieve VIP-MEMBER data with inactive status']];
        }
