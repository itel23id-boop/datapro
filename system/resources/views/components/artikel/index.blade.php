        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="artikel-item">
                    <span class="category mb-2">{{ $data->category }}</span>
                </div>
                <h4 class="fw-600 lh-26">{{ $data->title }}</h4>
                <hr>
                <div class="mb-4">
                    <div class="artikel-data d-inline-block ms-2">
                        <span class="author">{{ $data->author }}</span>
                        <span class="date"><span class="d-inline-block ms-1 me-2">•</span>{{ $date.' ('.substr($time[1],0,5).' WIB)' }}</span>
                    </div>
                </div>
                <img src="{{ $data->path }}" class="w-100 d-block mb-4 rounded">
            </div>
        </div>
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="mt-4">
                <h6 class="fw-600">Tags</h6>
                    <?php 
                        $tags = DB::table('artikel_tags')->where('artikel_id',$data->id)->get();
                    ?>
                ...
                <div class="mt-4">
                    <h6 class="fw-600">Share This Article</h6>
                ...
                <div class="mt-3">
                    ...
                    <h5 class="fw-600">Berita Lainnya</h5>
                    <div class="row mb-5">
                        <!-- start foreach -->
