			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="card border-0 shadow-form">
						<div class="card-body">
							<h6 class="card-title">Isi Saldo #{{ $data->order_id }}</h6>
							<a href="/user/topup/riwayat" class="text-decoration-none mb-2 d-block">
							...
							<div class="table-responsive">
								...
								<p><b>Total</b> harga sudah termasuk biaya admin pembayaran</p><br>
								@if($data->status == "Menunggu Pembayaran")
								<div class="">
