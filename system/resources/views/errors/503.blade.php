<!doctype html>
<title>{{ !$config ? '' : $config->judul_web }} - Site Maintenance</title>
...
<article>
    ...
    <div>
        <p>Sorry for the inconvenience. We&rsquo;re performing some maintenance at the moment. If you need to you can always follow us on <a href="{{ !$config ? '' : $config->url_ig }}">Instagram</a> <b>or</b> <a href="{{ !$config ? '' : $config->url_youtube }}">Youtube</a> for updates, otherwise we&rsquo;ll be back up shortly!</p>
