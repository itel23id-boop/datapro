			...
			<div class="row justify-content-center">
				<div class="col-md-12 d-none-mobile">
					<div class="card mb-4 border-0 shadow-form">
					    <div class="card-body">
					        <p class="mb-0">{!! $kategori->deskripsi_game !!}</p>
					    </div>
				...
				<div class="col-md-10">
                    ...
                    @endif
					<div class="card mb-4 border-0 shadow-form" id="section-item">
						    ...
						    <div class="card-body">
        						...
        						<div class="product-category">
								    <div class="product-category-item from-murky-700 bg-gradient-to-t active" id="category-all" onclick="show_category('all');">
								        <img src="{{ url('') }}{{ !$config ? '' : $config->logo_favicon }}" style="height:auto;width:50px;">
								        <span>Semua</span>
								    </div>
        						...
        						@else
        						@foreach($pakets as $paket)
    								<div class="row row-category" id="row-{{ $paket['id'] }}">
						...
						<div class="card mb-4 border-0 shadow-form" id="section-order">
    						<div class="card-body">
    								<h6 class="card-title">
    								    Masukkan Data								    
    								    ...
    								    @foreach ($kategori->kategori_input as $item)
    								        @if($item->server_id == 'seo')
            									...
            									<div class="col-md-4 mb-3">
            										...
            										<input type="text" class="form-control form-control-games games-input" id="keywords" placeholder="Keywords" autocomplete="off" >
            									</div>
            									<div class="col-md-4 mb-3">
                								    <label>Jumlah/Quantity <span class="badge bg-info" id="infoMin">Min: 0</span>|<span class="badge bg-info" id="infoMax">Max: 0</span></label>
    								        ...
    								        @else
    								            <div class="col-md-4 mb-3">
            										...
            										<input type="text" class="form-control form-control-games games-input" name="target[]" id="{{$item->value}}" placeholder="{{$item->name}}" autocomplete="off" value="">
            									</div>
            								@endif
            								@if(in_array($item->server_id,['user_id','seo','mentions_hashtag','mentions_user_followers','mentions_media_likers','poll','custom_comments','comment_replies']))
            								<div class="col-md-4 mb-3">
            								    <label>Jumlah/Quantity <span class="badge bg-info" id="infoMin">Min: 0</span>|<span class="badge bg-info" id="infoMax">Max: 0</span></label>
            								    <input type="number" name="qty" id="qty" class="form-control" value="1" required min="1" {{in_array($item->server_id,['custom_comments','comment_replies']) ? 'readonly' : ''}}>
            								</div>
            								...
            								<div class="col-md-4 mb-3">
            								    <label>Custom Comments (1 per row)</label>
            								    <textarea class="form-control form-control-games games-input" id="custom_comments" rows="5"></textarea>
            								</div>
            								@endif
    									@endforeach
    								</div>
    							<p class="text-muted fs-12">{!! $kategori->deskripsi_field !!}</p>
    						</div>
    					</div>
						<div class="card mb-4 border-0 shadow-form" id="section-method">
						    <div class="card-body">
								<h6 class="card-title">Metode Pembayaran</h6>
								<div class="row">
                        			<p class="" style="font-size: 13px;color: white;">
                        				*Optional: Jika tidak mempunyai kode promo abaikan saja.
                        			</p>
                        			<div class="col-md-6">
    									<input type="text" class="form-control" id="voucher" name="voucher" placeholder="Code [VOCERxxxx]">
    								</div>
    								<div class="col-md-6">
								...
								<div class="accordion mb-2 mt-3" id="accordionExample">
								    ...
								    <div class="border-0 mb-4">
								        <h2 class="accordion-header" id="heading-7">
								            <button style="background: var(--warna_5);border-radius: 6px 6px 0 0;" class="accordion-button collapsed text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-7" aria-expanded="false" aria-controls="collapse-7">Bank Transfer (Dicek Manual)</button>
								        </h2>
    													    ...
    													    <span class="flex w-full flex-col justify-between">
    													        ...
    													        <div class="flex w-full items-center justify-between">
    													            <div class="mt-2 w-full">
    													                ...
    													                <div>
    													                    <span class="block text-xxs italic text-murky-800" id="namapembayaran">{{$p->name}}</span>
    													                </div>
    													            </div>
    													        </div>
    													    </span>
								    ...
								    <div class="border-0 mb-4">
								        <h2 class="accordion-header" id="heading-5">
								            <button style="background: var(--warna_5);border-radius: 6px 6px 0 0;" class="accordion-button collapsed text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-5" aria-expanded="false" aria-controls="collapse-5">QRIS (Dicek Otomatis)</button>
								        </h2>
								    ...
								    <div class="border-0 mb-4">
								        <h2 class="accordion-header" id="heading-1">
								            <button style="background: var(--warna_5);border-radius: 6px 6px 0 0;" class="accordion-button collapsed text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="false" aria-controls="collapse-1">E-Wallet (Dicek Otomatis)</button>
								        </h2>
									...
									<div class="border-0 mb-4">
								        <h2 class="accordion-header" id="heading-2">
								            <button style="background: var(--warna_5);border-radius: 6px 6px 0 0;" class="accordion-button collapsed text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-2" aria-expanded="false" aria-controls="collapse-2">Virtual Account (Dicek Otomatis)</button>
								        </h2>
									...
									<div class="border-0 mb-4">
								        <h2 class="accordion-header" id="heading-3">
								            <button style="background: var(--warna_5);border-radius: 6px 6px 0 0;" class="accordion-button collapsed text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-3" aria-expanded="false" aria-controls="collapse-3">Retail Outlets (Dicek Otomatis)</button>
								        </h2>
								    ...
								    <div class="border-0 mb-4">
								        <h2 class="accordion-header" id="heading-6">
								            <button style="background: var(--warna_5);border-radius: 6px 6px 0 0;" class="accordion-button collapsed text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-6" aria-expanded="false" aria-controls="collapse-6">Pulsa (Dicek Otomatis)</button>
								        </h2>
									...
									<div class="border-0">
								        <h2 class="accordion-header" id="heading-4">
								            <button style="background: var(--warna_5);border-radius: 6px 6px 0 0;" class="accordion-button collapsed text-white" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-4" aria-expanded="false" aria-controls="collapse-4">Saldo Akun (Member)</button>
								        </h2>
    													    ...
    													    <span class="flex w-full flex-col justify-between">
    													        ...
    													        <div class="flex w-full items-center justify-between">
    													            <div class="mt-2 w-full">
    													                ...
    													                <div class="mt-0.5 h-px w-full bg-murky-300"></div>
    													                <div>
    													                    <span class="block text-xxs italic text-murky-800" id="namapembayaran">{{ ENV("APP_NAME") }} Cash</span>
    													                </div>
    													            </div>
    													        </div>
    													    </span>
					    ...
					    <div class="card border-0 shadow-form mb-4" id="section-bukti">
						    <div class="card-body">
								<div class="mb-4">
					...
					<div class="sticky inset-x-0 bottom-0 z-10 -mx-4 !mt-0 w-screen d-md-none mb-4" style="backdrop-filter: blur(8px);border-radius: 30px 30px 30px;">
                            ...
                            <div class="flex items-start justify-start space-x-4 py-1 md:hidden">
                                <div class="mb-2 aspect-square">
                                    <img alt="icon" sizes="100vw" srcset="{{ $kategori->thumbnail }}"
                                        src="{{ $kategori->thumbnail }}" width="100" height="100" decoding="async"
                                        data-nimg="1" class="aspect-square rounded-lg object-cover" loading="lazy"
            					...
            					<div class="py-0">
                                    <div class="flex items-center">
                                        <div class="w-full">
                                            <div class="flex items-start justify-between">
                                                @php
                                                    $username = $ratings->username ?? $ratings->no_pembeli ?? 'Guest';
                                                ...
                                                @endphp
                                                <div><h4 class="mt-0.5 text-xs font-bold text-white">{{ $censoredUsername }}</h4></div>
                                                <div class="flex items-center">
                                                @for($i=1; $i<=5; $i++) 
                                                    @if($i <= $ratings->bintang)
                                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" class="text-yellow-400 h-4 w-4 flex-shrink-0">
                                    ...
                                    <div class="flex w-full justify-between pt-1 text-xxs"><span>{{ $ratings->layanan }}</span><span>{{ $ratings->created_at }}</span></div>
                                    <div class="text-murky-20 mt-1 space-y-6 text-xs italic">“{{ $ratings->comment }}”</div>
                                    </div><hr>
            					    @endforeach
...
<script type="text/javascript">
		...
		function order_confirms() {
			...
			if (!target || target == ' ' || target == '' || target == ',') {
				...
				$("#tr-method td").text($("#method-" + method + " #namapembayaran").text());
